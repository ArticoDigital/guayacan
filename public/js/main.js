...
var _ZoomMap = __webpack_require__(2);
...
if (document.querySelector('#Choachi')) {
    ...
    mapClick.forEach(function (el) {
        el.addEventListener('click', function () {
            ...
            (0, _modal2.default)(el.dataset.city, lang);
        });
    });
    if (modalClose) {
...
exports.default = function (city, lang) {
    title.innerHTML = infoModal[lang][city].title;
    subtitle.innerHTML = infoModal[lang][city].subtitle;
    content.innerHTML = infoModal[lang][city].content;
    url.setAttribute('href', infoModal[lang][city].url);
    image.style.backgroundImage = "url('" + infoModal[lang][city].image + "')";
};
...
var infoModal = {
    ...
    'fr-FR': {
        'bogota': {
            'title': 'Bogotá',
            'subtitle': '2600 m plus près des étoiles',
            'content': 'A l’ombre du Monserrate (3152 m), la capitale colombienne s’agite du lever au coucher du soleil. Le visiteur sera surpris par une ville contrastée entre les buildings contemporains et le quartier colonial de la Candelaria dont une grande partie fut détruite par la foule en colère après l’assassinat du très populaire leader libéral Gaitàn en 1948 (Bogotaso).',
            'url': 'http://guayacantrace.com/fr/bogota-2/',
            'image': 'http://guayacantrace.com/wp-content/uploads/2018/09/slide-Bogota-2-e1536265838952.jpg'
        },
        'villa': {
            'title': 'Villa de Leyva',
            'subtitle': 'Le berceau de la République',
            'content': 'Fondée en 1572, Villa de Leyva, situé à 160 km au Nord-Est de Bogota (3h00), est l’un des joyaux architecturaux du passé colonial de la Colombie avec ses balcons, ses rues en pierres et son immense place centrale au charme inégalable. C´est dans ce petit village où fleurissent aujourd’hui restaurants et salons de thé que les libertadores Simon Bolivar, Antonio Nariño et Camilo Torres signèrent en 1812 les lois de la Première République Colombienne.',
            'url': 'http://guayacantrace.com/fr/villa-de-leyva-2/',
            'image': 'http://guayacantrace.com/wp-content/uploads/2018/09/slide-villa-de-leyva-1.jpg'
        },
        'choachi': {
            'title': 'Choachi',
            'subtitle': 'Une fenêtre sur la lune',
            'content': 'Le dépaysement total à quelques kilomètres de Bogota ! En quelques minutes, la ville s’oublie dans les montagnes et laisse place aux paysages lunaires du páramo, immensité silencieuse et brumeuse qui donne envie de se perdre et d’oublier un moment l’effervescence du quotidien et de la civilisation. Marcher sur les chemins de pierre séculaires (caminos reales) transformés en ruisseau… Marcher vers les sources et les lagunes… Marcher vers les sommets… Randonneurs débutants ou confirmés, chacun trouvera son compte le temps de quelques heures. ',
            'url': 'http://guayacantrace.com/fr/choachi-2/',
            'image': 'http://guayacantrace.com/wp-content/uploads/2018/09/slide-choachi-1-e1536340938271.jpg'
        },
        'guatavita': {
            'title': 'Guatavita',
            'subtitle': 'L’origine de la légende de l’Eldorado\n',
            'content': 'Découvrez le lac sacré des indiens muiscas à l’origine du mythe de l’El Dorado à 75 km au Nord de Bogota (1h30 de route).\n' + '\n' + 'Lors de sa prise de pouvoir, le chef muisca (cacique) se recouvrait de poudre d’or avant de plonger d’un radeau au milieu du lac sous les yeux de la communauté qui jetait des objets en or dans les eaux en guise d’offrandes. Au XVIème siècle, le rite fit fantasmer les Européens qui multiplièrent les tentatives pour récupérer le précieux métal accumulé au cours du temps.',
            'url': 'http://guayacantrace.com/fr/guatavita-2/',
        ...
        'trait': {
            ...
            'content': 'Qui n’a jamais rêvé de pratiquer sa passion de la marche en cheminant dans la forêt tropicale sur les traces des civilisations précolombiennes ? Quel coureur ne s’est pas un jour imaginé entrain de sillonner les sentiers des montagnes andines à toute allure ? GUAYACAN TRACE vous propose de vous faire vivre l’aventure colombienne au travers de votre passion. En deux semaines, visitez les sites naturels et culturels incontournables de Colombie tout en pratiquant votre sport favori. Découvrez d’abord Bogota et ses alentours. Marches sportives, sorties trail, prenez de l´altitude pour admirer les paysages andins à plus de 3500 m d’altitude. ',
            'url': 'http://guayacantrace.com/fr/rando-trail/',
